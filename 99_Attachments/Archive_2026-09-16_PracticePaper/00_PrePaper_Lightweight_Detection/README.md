> **2026-09-16 归档说明：** 本目录为历史练手方案（LSM-Head）**源文件保留、不删除**。学习已合并到 [`00_Startup_Railway_UAV_Detection/`](../00_Startup_Railway_UAV_Detection/LEARNING_CORE.md)。完整快照另存 [`99_Attachments/Archive_2026-09-16_PracticePaper/00_PrePaper_Lightweight_Detection/`](../99_Attachments/Archive_2026-09-16_PracticePaper/00_PrePaper_Lightweight_Detection/)。LSM-Head 仅作线索 A 历史候选学习，不是当前执行创新。本 README 旧「阶段0当前 / 唯一进度表」**不再作为项目进度**。
