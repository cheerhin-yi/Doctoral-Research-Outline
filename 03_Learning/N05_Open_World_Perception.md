...
> 状态：PAUSED｜最近复习：待填写｜启动门槛：前置论文A、B达到投稿或内部投稿标准后恢复Paper 1

**当前范围（2026-08-28）**：前置论文A、B均为封闭集研究，本模块不得进入当前阅读、代码或实验清单。只允许在创新边界核查时查阅术语，不运行YOLO-World、Grounding DINO、OWOD或未知类实验。
