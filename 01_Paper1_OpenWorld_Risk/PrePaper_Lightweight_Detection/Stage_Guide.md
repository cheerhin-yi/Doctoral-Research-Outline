...
1. [小目标与多尺度检测](Learning_Notes/01_Small_Object_and_Multiscale.md)；
2. [轻量共享检测头](Learning_Notes/02_Lightweight_Shared_Head.md)；
3. [速度评价与简单部署](Learning_Notes/03_Efficiency_and_Deployment.md)。
...
继续补齐共同YOLO和PyTorch基础；完成后从[小目标与多尺度检测](Learning_Notes/01_Small_Object_and_Multiscale.md)开始。不要提前下载数据或实现检测头。
