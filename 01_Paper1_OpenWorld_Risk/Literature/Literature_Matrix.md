...
|---|---|---|---|---|---|
| W-0001 | P0 | [主审计与正文入口](../../00_Practice_UAV_Aerial_Detection/Literature/audits/W-0001_Audit.md)；[P0矩阵](../../00_Practice_UAV_Aerial_Detection/Literature/matrices/Literature_Matrix.md) | 铁路UAV数据、已知框与轨道分割参考；不提供未知／风险证据 | P1-C1/C2（范围参考） | Reference Only；原阶段门保持；2026-09-10 |
| W-0006 | P0 | [主审计与正文入口](../../00_Practice_UAV_Aerial_Detection/Literature/audits/W-0006_Audit.md)；[P0矩阵](../../00_Practice_UAV_Aerial_Detection/Literature/matrices/Literature_Matrix.md) | 已知异物轻量基线，计时排除CPU NMS；不支持风险排序 | P1-C1（已知路径参考） | Reference Only；原阶段门保持；2026-09-10 |
