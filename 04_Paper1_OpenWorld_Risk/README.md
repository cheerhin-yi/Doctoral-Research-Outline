...
暂定题目：**Open-World Risk-Aware Perception for UAV Railway Inspection**。

当前目标是在本轮16个弹性研究周内形成可复现的开放环境风险感知实验链和完整初稿。研究周不绑定固定日历日期。项目不是普通异物检测；必须连接铁路解析、铁路归一化几何、未知性、风险与校准不确定性。
