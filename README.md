...
老师您好，我想申请《人工智能前沿导论》本科课程助教岗位。我具有电子与通信工程背景，具备人工智能与软件开发基础，熟悉Python、PyTorch、TensorFlow等技术，并有相关科研论文及多年工程项目实践经验。目前博士阶段研究也重点关注人工智能感知及智能决策等方向。希望能够发挥科研与工程实践优势，协助老师完成课程教学、答疑及实践指导工作，同时帮助本科生更好地理解人工智能前沿技术及其实际应用。
您好，我具有电子与通信工程硕士背景，目前主要开展人工智能相关研究。硕士阶段曾以第一作者发表基于自编码器的无线电环境地图研究论文，具备机器学习与深度学习基础；熟悉Python、PyTorch、TensorFlow及Linux等开发环境。同时拥有多年软件研发和项目管理经验，能够将人工智能理论与实际工程问题相结合。希望通过助教工作协助课程教学与学生答疑，并将科研和工程经验融入本科生的人工智能前沿学习中。
